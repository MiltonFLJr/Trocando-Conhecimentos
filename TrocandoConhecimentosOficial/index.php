...
<html>
<head>
<title>Training a Education category Flat bootstrap Responsive  Website Template | Home :: w3layouts</title>
	...
	<div class="container">
		<div class="header">
			<div class="col-md-7 logo">
				<a href="index.html"><h1>Trocando Conhecimentos ernandes</h1></a>
			</div>
			<div class="col-md-5 details">
				<div class="addre">
					<!-- SEM USO! <span class="location"> </span> SEM USO! -->
					...
					<span class="tel-ph"> </span>
					 <div class="detail-para">					
                      SEM USO! -->
						...
						<!-- SEM USO! 
						<p> Email: <a href="mailto:info@example.com">@lorem.com</a></p>
                        SEM USO! -->
		...
		<div class="top-nav">
			<div class="navbar-header">
	              ...
	              <ul class="nav navbar-nav">
					  ...
					  <li class=""><a href="shortcodes.html">Contato</a></li>
					  <!-- SEM USO!
		 ...
		 <div class="banner-bottom">
		 	<div class="bann-para">
		 	<h2>TESTANDO LAYOUT</h2>
		 	<p>TESTNAOD ESSE LAYOUT</p>
		   </div>
		   <a href="#">Ler mais...</a>
		 </div>
	</div>
...
<div class="welcome">
	<div class="container">
		<div class="wel-main">
		  <div class="wel-top">
			<h3>Ultimos livros adicionados!</h3>
             <br>
	      ...
	      <div class="wel-bottom">
	      	  <div class="col-md-6 wel-left">
	      	    ...
	      	    <div class="wel-block">
		      	  	 ...
		      	  	 <div class="wel-text">
		      	  	 	<h4>Temporibus autem</h4>
		      	  	 	<p>To take a trivial example, which of us ever undertakes laborious physical exercise</p> 		      	  	 </div> 
		      	   <div class="clearfix"> </div>
	      	    </div>
	      	  </div>
